...
from
'sources/QOF_2020_2021/MAPPING_NHS_GEOGRAPHIES_2021.csv'
)

to 'sources/gp_organisations_2020_2021.parquet' (format parquet) ;

summarize from (select * from 'sources/gp_organisations_2020_2021.parquet') ;
